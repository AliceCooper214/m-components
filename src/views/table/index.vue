<template>
  <m-table :options="options" :data="tableData" elementLoadingText="加载中..." elementLoadingBackground="rgba(0,0,0,.8)"
    ...
    <template #editRow="scope">
      <el-button size="default" type="primary" @click="sure(scope.scope)">确认</el-button>
      <el-button size="default" type="danger">取消</el-button>
    </template>
    <template #action="scope">
      <el-button size="default" type="primary" @click="edit(scope.scope)">编辑</el-button>
